...
var _SAS_LT={
  ITALIANO:{title:"VALORE SAS → FATTURATO",logic:"Quota del valore SAS del negozio riconosciuta nel fatturato verso il target (in base ad accettazione e velocità). Fino al 100%; l'avanzo è riserva riportata al mese successivo.",vel:"Velocità",velLabel:"% gestiti entro 4h",acc:"Accettazione",recPct:"% riconosciuta",sasVal:"Valore SAS negozio",recVal:"Valore SAS riconosciuto",applied:"Applicato al fatturato",resIn:"Riserva mese prec.",reserve:"Riserva riportata",nodata:"Dato SAS non disponibile per questo negozio."},
  INGLESE:{title:"SAS VALUE → TURNOVER",logic:"Share of the store's SAS value recognised toward the turnover target (based on acceptance and speed). Up to 100%; the surplus is a reserve carried to next month.",vel:"Speed",velLabel:"% handled within 4h",acc:"Acceptance",recPct:"Recognised %",sasVal:"Store SAS value",recVal:"Recognised SAS value",applied:"Applied to turnover",resIn:"Previous month reserve",reserve:"Reserve carried over",nodata:"SAS data not available for this store."},
