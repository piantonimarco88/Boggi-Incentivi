...
var _DEMOLT_LT={
  ITALIANO:{title:"DEMOLTIPLICATORE INVENTARI",logic:"Riduzione del premio in base alla % di completamento degli inventari giornalieri (completati/mandati) e all'accuracy mensile.",logicArea:"Riduzione del premio d'area in base alla % di invio degli inventari giornalieri (mandati/max possibile) e alla % di completamento (completati/mandati), aggregate su tutta l'area.",axisA:"% Completamento",axisB:"Accuracy",axisAArea:"% Invio",axisBArea:"% Completamento",pctLbl:"% premio riconosciuta",maturato:"Premio maturato",erogare:"Premio da erogare",nodata:"Dato inventari non ancora disponibile per questo negozio.",nodataArea:"Dato inventari non ancora disponibile per quest'area."},
...
function buildLetter(e){
  ...
  // Demoltiplicatore Inventari — solo SM/VSM, solo da ottobre 2026 (vedi demoltActive()). In preventivo
