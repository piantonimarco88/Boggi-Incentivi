...
var _SAS_LT={
  ITALIANO:{title:"VALORE SAS → FATTURATO",logic:"Quota del valore SAS del negozio riconosciuta nel fatturato verso il target (in base ad accettazione e velocità). Fino al 100%; l'avanzo del riconosciuto di questo mese è riserva riportata al mese successivo — la riserva del mese precedente non si accumula: copre il gap e poi scade, usata o no.",vel:"Velocità",velLabel:"% gestiti entro 4h",acc:"Accettazione",recPct:"% riconosciuta",sasVal:"Valore SAS negozio",recVal:"Valore SAS riconosciuto",applied:"Applicato al fatturato",turnoverSurplus:"Esubero fatturato",resIn:"Riserva SAS mese prec.",resInUsed:"— di cui usata",resInExpired:"— di cui scaduta (non riportata)",reserve:"Riserva riportata",nodata:"Dato SAS non disponibile per questo negozio.",towardTarget:"Fatturato + SAS verso target",reached:"target raggiunto",below:"sotto target",withoutSas:"Senza SAS",logicArea:"Quota del valore SAS dell'area riconosciuta nel fatturato verso il target (in base ad accettazione e velocità aggregate dell'area). Fino al 100%; l'avanzo del riconosciuto di questo mese è riserva riportata al mese successivo — la riserva del mese precedente non si accumula: copre il gap e poi scade, usata o no.",sasValArea:"Valore SAS area",nodataArea:"Dato SAS non disponibile per quest'area."},
  INGLESE:{title:"SAS VALUE → TURNOVER",logic:"Share of the store's SAS value recognised toward the turnover target (based on acceptance and speed). Up to 100%; the surplus of this month's recognised value is a reserve carried to next month — last month's reserve does not accumulate: it covers the gap and then expires, whether used or not.",vel:"Speed",velLabel:"% handled within 4h",acc:"Acceptance",recPct:"Recognised %",sasVal:"Store SAS value",recVal:"Recognised SAS value",applied:"Applied to turnover",turnoverSurplus:"Turnover surplus",resIn:"SAS reserve prev. month",resInUsed:"— of which used",resInExpired:"— of which expired (not carried over)",reserve:"Reserve carried over",nodata:"SAS data not available for this store.",towardTarget:"Turnover + SAS toward target",reached:"target reached",below:"below target",withoutSas:"Without SAS",logicArea:"Share of the area's SAS value recognised toward the turnover target (based on the area's aggregate acceptance and speed). Up to 100%; the surplus of this month's recognised value is a reserve carried to next month — last month's reserve does not accumulate: it covers the gap and then expires, whether used or not.",sasValArea:"Area SAS value",nodataArea:"SAS data not available for this area."},
  FRANCESE:{title:"VALEUR SAS → CA",logic:"Part de la valeur SAS du magasin reconnue dans le CA vers l'objectif (selon acceptation et rapidité). Jusqu'à 100% ; l'excédent du reconnu de ce mois est une réserve reportée au mois suivant — la réserve du mois précédent ne s'accumule pas : elle couvre l'écart puis expire, utilisée ou non.",vel:"Rapidité",velLabel:"% traités sous 4h",acc:"Acceptation",recPct:"% reconnue",sasVal:"Valeur SAS magasin",recVal:"Valeur SAS reconnue",applied:"Appliqué au CA",turnoverSurplus:"Excédent CA",resIn:"Réserve SAS mois préc.",resInUsed:"— dont utilisée",resInExpired:"— dont expirée (non reportée)",reserve:"Réserve reportée",nodata:"Donnée SAS non disponible pour ce magasin.",towardTarget:"CA + SAS vers l'objectif",reached:"objectif atteint",below:"sous l'objectif",withoutSas:"Sans SAS",logicArea:"Part de la valeur SAS de la zone reconnue dans le CA vers l'objectif (selon l'acceptation et la rapidité agrégées de la zone). Jusqu'à 100% ; l'excédent du reconnu de ce mois est une réserve reportée au mois suivant — la réserve du mois précédent ne s'accumule pas : elle couvre l'écart puis expire, utilisée ou non.",sasValArea:"Valeur SAS zone",nodataArea:"Donnée SAS non disponible pour cette zone."},
  TEDESCO:{title:"SAS-WERT → UMSATZ",logic:"Anteil des SAS-Werts des Stores, der auf das Umsatzziel angerechnet wird (nach Annahme und Geschwindigkeit). Bis 100%; der Überschuss des in diesem Monat anerkannten Werts ist eine in den Folgemonat übertragene Reserve — die Reserve des Vormonats summiert sich nicht: sie deckt die Lücke und verfällt danach, ob genutzt oder nicht.",vel:"Geschwindigkeit",velLabel:"% innerhalb 4h bearbeitet",acc:"Annahme",recPct:"Anerkannt %",sasVal:"SAS-Wert Store",recVal:"Anerkannter SAS-Wert",applied:"Auf Umsatz angerechnet",turnoverSurplus:"Umsatzüberschuss",resIn:"SAS-Reserve Vormonat",resInUsed:"— davon genutzt",resInExpired:"— davon verfallen (nicht übertragen)",reserve:"Übertragene Reserve",nodata:"SAS-Daten für diesen Store nicht verfügbar.",towardTarget:"Umsatz + SAS zum Ziel",reached:"Ziel erreicht",below:"unter Ziel",withoutSas:"Ohne SAS",logicArea:"Anteil des SAS-Werts des Bereichs, der auf das Umsatzziel angerechnet wird (nach aggregierter Annahme und Geschwindigkeit des Bereichs). Bis 100%; der Überschuss des in diesem Monat anerkannten Werts ist eine in den Folgemonat übertragene Reserve — die Reserve des Vormonats summiert sich nicht: sie deckt die Lücke und verfällt danach, ob genutzt oder nicht.",sasValArea:"SAS-Wert Bereich",nodataArea:"SAS-Daten für diesen Bereich nicht verfügbar."},
  SPAGNOLO:{title:"VALOR SAS → FACTURACIÓN",logic:"Parte del valor SAS de la tienda reconocida en la facturación hacia el objetivo (según aceptación y velocidad). Hasta el 100%; el excedente del reconocido de este mes es reserva trasladada al mes siguiente — la reserva del mes anterior no se acumula: cubre el gap y luego caduca, usada o no.",vel:"Velocidad",velLabel:"% gestionados en 4h",acc:"Aceptación",recPct:"% reconocido",sasVal:"Valor SAS tienda",recVal:"Valor SAS reconocido",applied:"Aplicado a facturación",turnoverSurplus:"Excedente facturación",resIn:"Reserva SAS mes ant.",resInUsed:"— de la cual usada",resInExpired:"— de la cual caducada (no trasladada)",reserve:"Reserva trasladada",nodata:"Dato SAS no disponible para esta tienda.",towardTarget:"Facturación + SAS hacia objetivo",reached:"objetivo alcanzado",below:"bajo objetivo",withoutSas:"Sin SAS",logicArea:"Parte del valor SAS de la zona reconocida en la facturación hacia el objetivo (según aceptación y velocidad agregadas de la zona). Hasta el 100%; el excedente del reconocido de este mes es reserva trasladada al mes siguiente — la reserva del mes anterior no se acumula: cubre el gap y luego caduca, usada o no.",sasValArea:"Valor SAS zona",nodataArea:"Dato SAS no disponible para esta zona."}
};
...
function sasLetterBlock(lang,info,isP,cu,thPct,isArea){
  ...
  if(!isP){
    if(!hasData||info.pctMatrix==null){h+='<div style="font-size:10.5px;color:#a09a92;font-style:italic">'+esc(_nodataTxt)+'</div>';}
      ...
      if((info.reserveIn||0)>0){
        h+=row(T.resIn,eur(info.reserveIn));
        // La riserva del mese prec. viene consumata PRIMA per colmare il gap (vedi
        // sasReserveCalc): quanto di reserveIn è finito in "used" si ricava così,
        // senza bisogno di un campo dedicato nel motore di calcolo.
        var _resInUsed=Math.min(info.reserveIn||0,info.used||0);
        var _resInExpired=(info.reserveIn||0)-_resInUsed;
        if(_resInUsed>0)h+='<div style="display:flex;justify-content:space-between;font-size:10px;padding:1px 0 1px 10px"><span style="color:#a09a92">'+esc(T.resInUsed)+'</span><span style="color:#2d7a3a;font-weight:600">'+eur(_resInUsed)+'</span></div>';
        if(_resInExpired>0)h+='<div style="display:flex;justify-content:space-between;font-size:10px;padding:1px 0 1px 10px"><span style="color:#a09a92">'+esc(T.resInExpired)+'</span><span style="color:#cf5b5b;font-weight:600">'+eur(_resInExpired)+'</span></div>';
      }
...
// === Blocco Coefficiente Inventari per le lettere (mensile: SM/VSM; FC+VM: solo FC), da Ottobre 2026 ===
// dr: {pct, compl, acc} (negozio) oppure {pct, invio, compl} (area) — vedi 33-demolt-import/010_main.js. Solo consuntivo.
var _DEMOLT_LT={
  ITALIANO:{title:"COEFFICIENTE INVENTARI",logic:"Riduzione del premio in base alla % di completamento degli inventari giornalieri (completati/mandati) e all'accuracy mensile.",logicArea:"Riduzione del premio d'area in base alla % di invio degli inventari giornalieri (mandati/max possibile) e alla % di completamento (completati/mandati), aggregate su tutta l'area.",axisA:"% Completamento",axisB:"Accuracy",axisAArea:"% Invio",axisBArea:"% Completamento",pctLbl:"% premio riconosciuta",maturato:"Premio maturato",erogare:"Premio da erogare",nodata:"Dato inventari non ancora disponibile per questo negozio.",nodataArea:"Dato inventari non ancora disponibile per quest'area."},
  INGLESE:{title:"INVENTORY COEFFICIENT",logic:"Prize reduction based on daily inventory completion % (completed/sent) and monthly accuracy.",logicArea:"Area prize reduction based on daily inventory sending % (sent/max possible) and completion % (completed/sent), aggregated across the area.",axisA:"% Completion",axisB:"Accuracy",axisAArea:"% Sent",axisBArea:"% Completion",pctLbl:"% prize recognised",maturato:"Prize earned",erogare:"Prize to be paid",nodata:"Inventory data not yet available for this store.",nodataArea:"Inventory data not yet available for this area."},
  FRANCESE:{title:"COEFFICIENT INVENTAIRES",logic:"Réduction de la prime selon le % d'achèvement des inventaires quotidiens (complétés/envoyés) et l'accuracy mensuelle.",logicArea:"Réduction de la prime de zone selon le % d'envoi des inventaires quotidiens (envoyés/max possible) et le % d'achèvement (complétés/envoyés), agrégés sur toute la zone.",axisA:"% Achèvement",axisB:"Accuracy",axisAArea:"% Envoi",axisBArea:"% Achèvement",pctLbl:"% prime reconnue",maturato:"Prime acquise",erogare:"Prime à verser",nodata:"Données inventaires pas encore disponibles pour ce magasin.",nodataArea:"Données inventaires pas encore disponibles pour cette zone."},
  TEDESCO:{title:"INVENTUR-KOEFFIZIENT",logic:"Prämienreduzierung basierend auf dem täglichen Inventur-Abschluss% (abgeschlossen/gesendet) und der monatlichen Accuracy.",logicArea:"Reduzierung der Bereichsprämie basierend auf dem täglichen Inventur-Versand% (gesendet/maximal möglich) und dem Abschluss% (abgeschlossen/gesendet), aggregiert über den gesamten Bereich.",axisA:"% Abschluss",axisB:"Accuracy",axisAArea:"% Versand",axisBArea:"% Abschluss",pctLbl:"% anerkannte Prämie",maturato:"Erwirtschaftete Prämie",erogare:"Auszuzahlende Prämie",nodata:"Inventurdaten für diesen Store noch nicht verfügbar.",nodataArea:"Inventurdaten für diesen Bereich noch nicht verfügbar."},
  SPAGNOLO:{title:"COEFICIENTE INVENTARIOS",logic:"Reducción del premio según el % de finalización de los inventarios diarios (completados/enviados) y la accuracy mensual.",logicArea:"Reducción del premio de área según el % de envío de los inventarios diarios (enviados/máximo posible) y el % de finalización (completados/enviados), agregados en toda el área.",axisA:"% Finalización",axisB:"Accuracy",axisAArea:"% Envío",axisBArea:"% Finalización",pctLbl:"% premio reconocido",maturato:"Premio devengado",erogare:"Premio a pagar",nodata:"Datos de inventarios aún no disponibles para esta tienda.",nodataArea:"Datos de inventarios aún no disponibles para esta área."}
};
function demoltLetterBlock(lang,dr,isP,cu,isArea){
  ...
  var hasData=!isP&&dr&&dr.pct!=null; // import inventari disponibile solo in consuntivo
  var valA=hasData?(isArea?dr.invio:dr.compl):null,valB=hasData?(isArea?dr.compl:dr.acc):null;
  var aIdx=hasData?demoltBandIdx(valA,bpA):-1,bIdx=hasData?demoltBandIdx(valB,bpB):-1;
  ...
  h+='<table style="border-collapse:collapse;font-size:11px;margin:0 auto '+(isP?'0':'9px')+'"><thead><tr><th style="padding:3px 9px;color:#a09a92;text-align:right;font-weight:700">↓ '+esc(axisA)+'</th>';
  ...
  [2,1,0].forEach(function(ai){
    ...
    for(var c2=0;c2<3;c2++){var hit=(!isP&&ai===aIdx&&c2===bIdx);h+='<td style="padding:3px 11px;text-align:center;'+(hit?'background:#c9a96e;color:#fff;font-weight:700;border-radius:3px':'color:#9a958d')+'">'+Math.round(matrix.grid[ai][c2]*100)+'</td>';}
    h+='</tr>';
  });
  h+='</tbody></table>';
  if(!isP){
    if(!hasData){h+='<div style="font-size:10.5px;color:#a09a92;font-style:italic">'+esc(isArea?T.nodataArea:T.nodata)+'</div>';}
    else{
      var row=function(l,v){return '<div style="display:flex;justify-content:space-between;font-size:11px;padding:2px 0"><span style="color:#8a8680">'+esc(l)+'</span><span style="font-weight:600;color:#2c2925">'+v+'</span></div>';};
...
// Nota in linea su una singola voce di premio, quando è stata ridotta dal Coefficiente
// Inventari (getVal() lo applica a ogni voce raggiunta — vedi 88-calc-engine). Non mostrata se
// non c'è riduzione (pct>=1) o se il dato inventari non è disponibile (dr null/pct null).
function demoltVoceNote(dr,lang){
  if(!dr||dr.pct==null||dr.pct>=1)return '';
  var red=Math.round((1-dr.pct)*100),pct=Math.round(dr.pct*100);
  var lbls={
    ITALIANO:"Include Coefficiente Inventari: −"+red+"% (riconosciuto il "+pct+"% — dettaglio in fondo alla lettera)",
    INGLESE:"Includes Inventory Coefficient: −"+red+"% ("+pct+"% recognised — detail at the bottom of the letter)",
    FRANCESE:"Inclut le Coefficient Inventaires : −"+red+"% ("+pct+"% reconnu — détail en bas de la lettre)",
    TEDESCO:"Enthält Inventur-Koeffizient: −"+red+"% ("+pct+"% anerkannt — Details am Ende des Briefs)",
    SPAGNOLO:"Incluye Coeficiente Inventarios: −"+red+"% ("+pct+"% reconocido — detalle al final de la carta)"
  };
  return '<div style="font-size:9px;margin-top:4px;padding:4px 8px;background:#fff8ee;border-left:3px solid #c9a96e;color:#856404;border-radius:0 4px 4px 0">📋 '+esc(lbls[lang]||lbls.INGLESE)+'</div>';
}
...
function buildLetter(e){
  ...
  if(isOn(e.j,"rb")){sN++;var val=getVal(e,"rb"),p=val>0,vS=Math.round(val*sm);h+=secHd(sN,tr(e,"turnover","TURNOVER TARGET"),p,isP);
    ...
    if(!isP){h+=ltRow(tr(e,"balance","FINAL BALANCE"),'<span class="lt-row-cur">'+cu+"</span>"+Math.round(cn.sc+(cn.es||0)).toLocaleString("it-IT"));
      if(surplus>0){var _tsLbl=(typeof _SAS_LT!=='undefined'?((_SAS_LT[lang]||_SAS_LT.INGLESE).turnoverSurplus):'Turnover surplus');h+='<div style="font-size:9px;color:#a09a92;padding:2px 0;font-style:italic">'+esc(_tsLbl)+' (+'+Math.round(surplus).toLocaleString("it-IT")+")</div>";}
    ...
    if(!isP)h+=demoltVoceNote(_demDr,lang);
    if(!isP){
  ...
  if(tc>0&&_demDr&&_demDr.pct!=null){
    ...
    h+='<div class="lt-total"><div><div class="lt-total-label">'+totalLabel+'</div><div class="lt-total-pct">'+pctSal+esc(tr(e,"over_sal","% OVER SALARY"))+"</div></div><div class=\"lt-total-val\">"+fc(tc,cu)+"</div></div>";
    if(_demActive)h+=demoltLetterBlock(lang,_demDr,isP,cu,false);
  }
  else{
    h+='<div class="lt-total"><div><div class="lt-total-label" style="color:#cf5b5b">NO INCENTIVE</div></div><div class="lt-total-val" style="color:#6b6560">'+fc(0,cu)+"</div></div>";
    if(_demActive)h+=demoltLetterBlock(lang,_demDr,isP,cu,false);
  }
