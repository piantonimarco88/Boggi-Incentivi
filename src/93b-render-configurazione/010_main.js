function rT(){try{
  ...
  h+=pRow("bdg100","Soglia 100% Store","Soglia % fatturato negozio per riconoscere il premio BDG pieno",PARAMS.bdg100*100,"%",0.01)+pRow("kpi100","Soglia 100% KPI","Soglia per riconoscere raggiunto il target di SY, Privilege e QTY (es. 99,5% = accetta 99,5% del target)",PARAMS.kpi100*100,"%",0.01)+pRow("bdg60","Soglia ridotto","",PARAMS.bdg60*100,"%",0.01)+pRow("bdg60mult","Molt. ridotto","",PARAMS.bdg60mult*100,"%",0.01)+pRow("workgamePct","Workgame (% BDG)","Bonus manuale come % del premio BDG personale",(PARAMS.workgamePct||0)*100,"%",0.1);
